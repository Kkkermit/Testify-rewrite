			...
			try {
				...
				if (!channelId)
					return client.logs.error(
						`[PREFIX_COMMAND_LOGGING_ERROR] No channel ID provided in the config. Please provide a valid channel ID.`,
					);
				...
				console.log(
					`${color.purple}[${getTimestamp()}]${color.reset} [PREFIX_COMMAND_USED] ${user} has used a command. \n${
						color.purple
